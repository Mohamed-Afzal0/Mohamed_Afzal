...
| :--- | :--- |
| **Frontend** | React, JavaScript, HTML5, CSS3, Vite, Framer Motion |
| **Backend** | Node.js, Firebase, MySQL, Java, Python |
...
- **Tech Stack**: React, Vite, Framer Motion, Material UI.
- **Key Features**: 3D tire animation (React Three Fiber), responsive design, dynamic project section.
